...
export default function ClassStructure() {
  ...
  const PersonCard = ({ name, role, icon, delay = 0, isLeader = false }) => {
    ...
    return (
      ...
      >
        <div className={`group relative ${isLeader ? 'bg-gradient-to-br from-gray-900 to-black border-2 border-white/30' : 'bg-black border border-white/15'} hover:border-white/50 p-4 sm:p-5 transition-all duration-300 shadow-lg hover:shadow-xl rounded-lg overflow-hidden`}>
          ...
          <div className="relative flex flex-col items-center text-center z-10">
            <div className={`${isLeader ? 'w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-white/10 to-white/5' : 'w-10 h-10 sm:w-12 sm:h-12'} border ${isLeader ? 'border-white/40' : 'border-white/20'} rounded-full flex items-center justify-center mb-3 group-hover:border-white/60 transition-all duration-300`}>
              <IconComponent className={`${isLeader ? 'w-5 h-5 sm:w-6 sm:h-6' : 'w-4 h-4 sm:w-5 sm:h-5'} text-white/80 group-hover:text-white transition-colors duration-300`} />
            </div>
            <h3 className={`${isLeader ? 'text-sm sm:text-base font-medium' : 'text-xs sm:text-sm font-light'} text-white mb-1 tracking-wide`}>{name}</h3>
            <p className="text-[0.65rem] sm:text-xs text-white/60 uppercase tracking-wider">{role}</p>
            {isLeader && (
  ...
  const ConnectionLine = ({ horizontal = false, className = "" }) => (
    <div className={`bg-white/20 ${horizontal ? 'h-px w-full' : 'w-px h-6 sm:h-8'} ${className}`}></div>
  );

  return (
    <div className="min-h-screen bg-black text-white py-10 sm:py-16 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div 
          className={`text-center mb-10 sm:mb-14 transform transition-all duration-1000 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light tracking-[0.15em] mb-4">
            CLASS STRUCTURE
          </h1>
        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-10">
          ...
          <div className="flex flex-col items-center">
            <div className="w-px h-8 sm:h-10 bg-gradient-to-b from-white/40 to-white/20"></div>
            <div className="w-2 h-2 bg-white/40 rounded-full animate-pulse"></div>
            <div className="w-px h-4 sm:h-5 bg-gradient-to-b from-white/20 to-white/10"></div>
          </div>
          ...
          <div className="flex flex-col items-center relative w-full max-w-lg">
            ...
            {/* Enhanced connection line - hidden on mobile when stacked vertically */}
          ...
          <div className="flex flex-col items-center">
            <div className="w-px h-8 sm:h-10 bg-gradient-to-b from-white/30 to-white/20"></div>
            <div className="w-2 h-2 bg-white/40 rounded-full animate-pulse"></div>
            <div className="w-px h-4 sm:h-5 bg-gradient-to-b from-white/20 to-white/10"></div>
          </div>
          ...
          <div className="flex flex-col items-center mb-6 sm:mb-8 relative w-full">
            <h3 className="text-sm sm:text-base font-light text-white/80 uppercase tracking-widest mb-6 relative">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden lg:block">
              <div className="flex items-center space-x-4 sm:space-x-6">
                <div className="w-4 lg:w-6 h-px bg-gradient-to-r from-white/10 to-white/30"></div>
                <div className="w-4 lg:w-6 h-px bg-gradient-to-r from-white/30 to-white/30"></div>
                <div className="w-4 lg:w-6 h-px bg-gradient-to-r from-white/30 to-white/30"></div>
                <div className="w-4 lg:w-6 h-px bg-gradient-to-r from-white/30 to-white/30"></div>
                <div className="w-4 lg:w-6 h-px bg-gradient-to-r from-white/30 to-white/10"></div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            <div className="w-px h-10 sm:h-12 bg-gradient-to-b from-white/30 to-white/10"></div>
            <div className="w-2.5 h-2.5 bg-gradient-to-br from-white/50 to-white/30 rounded-full animate-pulse"></div>
            <div className="w-px h-5 sm:h-6 bg-gradient-to-b from-white/10 to-transparent"></div>
          </div>
          ...
          <div 
            className={`mt-10 sm:mt-12 text-center transform transition-all duration-1000 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
            style={{ transitionDelay: '2500ms' }}
          >
            <div className="border border-white/30 bg-gradient-to-br from-white/5 to-transparent px-6 sm:px-8 py-3 sm:py-4 inline-block relative rounded-lg overflow-hidden">
              ...
              <p className="relative text-white/80 text-xs sm:text-sm uppercase tracking-widest">
                Total Students: <span className="text-white font-medium text-base sm:text-lg">35</span>
              </p>
            </div>
          </div>
        </div>
