...
export default function ClassStructure() {
  ...
  const PersonCard = ({ name, role, icon, delay = 0, isLeader = false }) => {
    ...
    return (
      ...
      >
        <div className={`group relative ${isLeader ? 'bg-gradient-to-br from-gray-900 to-black border-2 border-white/30' : 'bg-black border border-white/20'} hover:border-white/40 p-4 sm:p-6 transition-all duration-300 shadow-xl`}>
          <div className="flex flex-col items-center text-center">
            <div className={`${isLeader ? 'w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-white/10 to-white/5' : 'w-10 h-10 sm:w-12 sm:h-12'} border border-white/30 rounded-full flex items-center justify-center mb-2 sm:mb-3 group-hover:border-white/50 transition-colors duration-300`}>
              <IconComponent className={`${isLeader ? 'w-5 h-5 sm:w-7 sm:h-7' : 'w-4 h-4 sm:w-5 sm:h-5'} text-white/70 group-hover:text-white transition-colors duration-300`} />
            </div>
  ...
  return (
    <div className="min-h-screen bg-black text-white py-10 sm:py-20 px-3 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-light tracking-[0.1em] sm:tracking-[0.2em] mb-4">
            CLASS STRUCTURE
          </h1>
        ...
        <div className="flex flex-col items-center space-y-8 sm:space-y-12">
          ...
          <div className="flex flex-col items-center relative w-full max-w-lg">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-12 lg:space-x-20 w-full">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden sm:block">
              <div className="w-12 lg:w-20 h-px bg-gradient-to-r from-white/20 via-white/40 to-white/20"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white/40 rounded-full"></div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-br from-white/40 to-white/20 rounded-full"></div>
          ...
          <div className="flex flex-col items-center w-full">
            <h3 className="text-base sm:text-lg font-light text-white/80 uppercase tracking-widest mb-6 sm:mb-8 relative">
              Class Members
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 sm:w-20 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent"></div>
            </h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-3 sm:gap-4 lg:gap-6 w-full max-w-6xl">
          ...
          >
            <div className="border-2 border-white/30 bg-gradient-to-br from-white/5 to-transparent px-6 sm:px-8 py-3 sm:py-4 inline-block relative">
