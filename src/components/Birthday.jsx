...
export default function Birthday() {
  ...
  const students = [
    ...
    { name: "Nazwa", birthday: "24-7-2008" },
    { name: "Quinsha", birthday: "17-02-2010" },
